...
try {
  ...
  prior.exec('DROP TABLE processing_decisions; DROP TABLE processing_evidence; DROP TABLE processing_origins; DROP TABLE processing_results; DROP TABLE processing_preferences; ALTER TABLE jobs DROP COLUMN processing_skips; DROP TABLE event_contexts; DROP TABLE plugin_source_history; DROP TABLE plugin_bindings; DROP TABLE source_grants;PRAGMA user_version=4;')
  prior.close()
  store = openStore(path)
