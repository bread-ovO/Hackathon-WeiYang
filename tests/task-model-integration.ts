...
try {
  ...
  legacy.exec(`DROP TABLE retraction_impacts; DROP TABLE object_retractions; ALTER TABLE source_events DROP COLUMN operation; DROP TABLE ingestion_limits; DROP TABLE processing_decisions; DROP TABLE processing_evidence; DROP TABLE processing_origins; DROP TABLE processing_results; DROP TABLE processing_preferences; ALTER TABLE jobs DROP COLUMN processing_skips; DROP TABLE event_contexts; DROP TABLE plugin_source_history; DROP TABLE plugin_bindings; DROP TABLE source_grants;DROP TABLE task_listing_fts;DROP TABLE notification_outbox;DROP TABLE manual_overrides;DROP TABLE task_revisions;DROP TABLE decisions;DROP TABLE evidence_links;DROP TABLE criteria;DROP TABLE criterion_sets;DROP TABLE event_projects;
  ...
  v3.exec(
    'DROP TABLE retraction_impacts; DROP TABLE object_retractions; ALTER TABLE source_events DROP COLUMN operation; DROP TABLE ingestion_limits; DROP TABLE processing_decisions; DROP TABLE processing_evidence; DROP TABLE processing_origins; DROP TABLE processing_results; DROP TABLE processing_preferences; ALTER TABLE jobs DROP COLUMN processing_skips; DROP TABLE event_contexts; DROP TABLE plugin_source_history; DROP TABLE plugin_bindings; DROP TABLE source_grants; DROP TABLE task_listing_fts; ALTER TABLE tasks DROP COLUMN due_at; PRAGMA user_version=3;',
  )
  const oldDecisions = (
